...
def Widgets():
    Label(root,text="GV's Youtube Video Downloader",font=('arial',25,'bold'),padx=5,pady=5,bg="DarkOrchid1",fg="white",justify=CENTER).grid(row=0,column=0,columnspan=10)
...
root.geometry("550x165") 
root.resizable(False, False) 
root.title("YouTube_Video_Downloader") 
root.config(background="plum1") 
